...
def payment_choice_finl():
    ...
    keyboard.add(
        ikb("📋 По форме(Не работает)", url="https://www.google.com/search?gs_ssp=eJzj4tTP1TcwMU02T1JgNGB0YPBiS8_PT89JBQBASQXT&client=opera-gx&q=google&sourceid=opera&ie=UTF-8&oe=UTF-8"), status_form_kb
    ).row(
        ikb("📞 По номеру(Не работает)", url="https://www.google.com/search?gs_ssp=eJzj4tTP1TcwMU02T1JgNGB0YPBiS8_PT89JBQBASQXT&client=opera-gx&q=google&sourceid=opera&ie=UTF-8&oe=UTF-8"), status_number_kb
    ).row(
        ikb("👷 Через оператора", url="https://t.me/willywonka2023"), status_nickname_kb
    )
